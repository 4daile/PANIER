...
- **Connexion internet** : Non requise après installation
...
5. **Cliquez** sur "Importer un module externe"
...
1. **Cliquez** sur le logo PANIER dans la barre des tâches en haut à droite
...
- [ ] Ajouter des interactions graphiques avancées dans l'interface du panier
- [ ] Mode "Organisation" pour créer des collections et sous-dossiers de fragments
- [ ] Personnalisation de l'expérience utilisateur (thèmes, couleurs, polices)
- [ ] Curseur personnalisé lors de la sélection
- [ ] Expansion de la partie web2print avec plusieurs formats d'exportation :
  - PDF classique
  - Fanzine
  - Leporello
  - Autres formats…
